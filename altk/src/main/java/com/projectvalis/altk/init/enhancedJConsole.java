...
/*
 * modified slightly to expose the text panel to the application
 * dh 28jul14
 */
...
*/
public class enhancedJConsole extends JScrollPane
	...
	MouseListener, ActionListener, PropertyChangeListener 
{
	...
	public enhancedJConsole() {
		this(null, null);
	}

	public enhancedJConsole( InputStream cin, OutputStream cout )  
	{
		super();
		...
		text = new JTextArea( doc=new DefaultStyledDocument() )	
			{
				public void	cut() {
		...
		text.setCaretColor(GUI.mustardC);
		text.setWrapStyleWord(true);
		text.setLineWrap(true);
		text.setForeground(GUI.mustardC);
		text.setBackground(GUI.charcoalC);
