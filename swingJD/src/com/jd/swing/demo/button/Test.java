...
public class Test {
	public static void main(String args[]) {
		...
		GlossyButton roundRectBtn = new GlossyButton("",Theme.GLOSSY_DARKYELLOW_THEME,ButtonType.BUTTON_ROUNDED_RECTANGLUR);
...
//		frame.add(circularBtn);
		...
		frame.getContentPane().add(new Test().getButtonsPanel());
	...
	public JPanel getButtonsPanel() {
		...
		for (Integer theme : themesList) {
			GlossyButton darkGreen_Btn = new GlossyButton(theme.toString(),
					theme);
